...
<head>
  ...
  <!-- Bootstrap Core CSS -->
  <link href="acb_web_store/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!-- Custom Fonts -->
  <link href="acb_web_store/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700,300italic,400italic,700italic" rel="stylesheet" type="text/css">
  <link href="acb_web_store/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      <img src="acb_web_store/img/logo.png" alt="Logo" width=250 height=250>
      <h2 class="mb-1">
        <!-- <em> -->Vista-se do seu ♡ próprio!
        <!-- </!-> -->
      </h2>
      <p class="lead mb-5">Loja Virtual</p>
      <!-- <h5 class="mb-5">
        <em>Loja Virtual</em>
      </h5> -->
      <!-- <h3 class="mb-5">
        <em>Vista-se do seu ♡ próprio!</em>
      </h3> -->
      <a class="btn btn-dark btn-xl js-scroll-trigger" href="#about">Descubra mais</a>
    </div>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <h2>Nós trabalhamos com marcas e produtos ideais pra você!</h2>
          <p class="lead mb-5">conheça as marcas parceiras da loja Amanda Costa Beauty!</p>
          <a class="btn btn-dark btn-xl js-scroll-trigger" id="btn-parceiras">"Clique aqui" e veja as marcas parceiras...</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6">
          <a class="portfolio-item" href="#!">
            ...
            <img class="img-fluid" src="acb_web_store/img/portfolio-1.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#!">
            ...
            <img class="img-fluid" src="acb_web_store/img/portfolio-2.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#!">
            ...
            <img class="img-fluid" src="acb_web_store/img/portfolio-3.jpg" alt="">
          </a>
        </div>
        <div class="col-lg-6">
          <a class="portfolio-item" href="#!">
            ...
            <img class="img-fluid" src="acb_web_store/img/portfolio-4.jpg" alt="">
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="modal-content bg-rosegold2">
        ...
        <div class="modal-body">
          ...
          <section class="content-section text-black text-center" id="services">
            <div class="container">
              <div class="content-section-heading">
                <h3 class="text-secondary mb-0">Marcas</h3>
                <h2 class="mb-5">Parceiras</h2>
              </div>
              <div class="row">
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                  <span class="service-icon rounded-circle mx-auto mb-3">
  ...
  <script src="acb_web_store/vendor/jquery/jquery.min.js"></script>
  <script src="acb_web_store/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Plugin JavaScript -->
  <script src="acb_web_store/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for this template -->
  <script src="acb_web_store/js/stylish-portfolio.min.js"></script>

  <!-- Open Modals -->
  <script>
    $("#btn-parceiras").click(function() {
      $("#modalMarcasParceiras").modal();
    });
  </script>
